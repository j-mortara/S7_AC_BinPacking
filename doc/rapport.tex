...
\subsection{Description théorique de l'algorithme}
L'algorithme Next Fit est très similaire à First Fit, la seule différence se fait lors de la recherche d'une boîte qui pourrait contenir l'item courrant, l'itération se fait à partir de la dernière boîte utilisé au lieu de la première.
...
\subsection{Description théorique de l'algorithme}
Almost Worst Fit est similiaire à Worst Fit excepté qu'il recherche la seconde boîte avec le plus d'espace disponible.
...
\section{Best Fit}
\subsection{Description théorique de l'algorithme}
Best Fit s'appuie sur la recherche de la boîte avec le plus petit espace suffisant pour l'item courant.
