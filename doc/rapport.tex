...
On constate dans cet exemple que \textit{first\_fit} n'utilise que 18 boîtes contre  17 boîtes pour \textit{best\_fit} cependant en terme de temps d'exécution,
\textit{best\_fit} est 3 fois plus long que \textit{first\_fit}.
...
\subsubsection{Analyse}
On constate dans cet exemple que \textit{first\_fit} n'utilise que 94 boîtes contre  93 boîtes pour \textit{best\_fit} cependant en terme de temps d'exécution,
\textit{best\_fit} est 7 fois plus long que \textit{first\_fit}.
...
\subsubsection{Analyse}
On constate dans cet exemple que \textit{first\_fit} n'utilise que 197 boîtes et \textit{best\_fit} 195 boîtes cependant en terme de temps d'exécution,
\textit{best\_fit} est 3 fois plus long que \textit{first\_fit}. 
...
\subsubsection{Analyse}
On constate dans cet exemple que  \textit{first\_fit} est le seul algorithme à avoir utilisé 7 boîtes contre 8 pour les autres algorithmes et de plus cet algorithme est
